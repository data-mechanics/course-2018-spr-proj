...
class Retrieve311Requests(dml.Algorithm):
    ...
    reads = []
    writes = [Constants.CONTRIBUTOR + ".service_requests"]
    ...
    def execute(trial = False):
        ...
        repo[Constants.BASE_AUTH + '.' + key].insert_many(r)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        service_requests = doc.entity('dat:' + Constants.BASE_NAME + '#service_requests',\
