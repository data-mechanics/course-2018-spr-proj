...
class getEnforcementData(dml.Algorithm):
    
    contributor = "bstc_semina"
    reads = []
    writes = ['bstc_semina.getEnforcementData']
    ...
    def execute(trial = False):
        ...
        repo.dropCollection('getEnforcementData')
        repo.createCollection('getEnforcementData')
        repo['bstc_semina.getEnforcementData'].insert_many(r)
        #print(type(repo['bstc_semina.ApiTest']))
        repo['bstc_semina.getEnforcementData'].metadata({'complete':True})
        print(repo['bstc_semina.getEnforcementData'].metadata())
...
getEnforcementData.execute()
doc = getEnforcementData.provenance()
print(doc.get_provn())
