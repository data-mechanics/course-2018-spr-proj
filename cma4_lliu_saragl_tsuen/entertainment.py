...
class entertainment(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        url = 'http://datamechanics.io/data/cma4_lliu_saragl_tsuen/entertainment.json'
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:cma4_lliu_saragl_tsuen#entertainment', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        entertainment = doc.entity('dat:cma4_lliu_saragl_tsuen#entertainment', {prov.model.PROV_LABEL:'Entertainment Places', prov.model.PROV_TYPE:'ont:DataSet'})
