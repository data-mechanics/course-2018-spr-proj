...
class mbta(dml.Algorithm):
    ...
    reads = []
    writes = ['cma4_lliu_saragl_tsuen.mbta']
    ...
    def execute(trial = False):
        ...
        repo.dropCollection("cma4_lliu_saragl_tsuen.mbta")
        repo.createCollection("cma4_lliu_saragl_tsuen.mbta")
        repo['cma4_lliu_saragl_tsuen.mbta'].insert_many(r)
        repo['cma4_lliu_saragl_tsuen.mbta'].metadata({'complete':True})
        print(repo['cma4_lliu_saragl_tsuen.mbta'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:cma4_lliu_saragl_tsuen#mbta', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        resource = doc.entity('dat:mbta', {'prov:label':'MBTA Stops Data', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        ...
        mbta = doc.entity('dat:cma4_lliu_saragl_tsuen#mbta', {prov.model.PROV_LABEL:'Bus Stops', prov.model.PROV_TYPE:'ont:DataSet'})
