...
class employeeearnings(dml.Algorithm):
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        doc.add_namespace('bdp', 'https://data.boston.gov/export/836/8bd/8368bd3d-3633-4927-8355-2a2f9811ab4f.json')

        this_script = doc.agent('alg:colinstu#employeeearnings',
                                {prov.model.PROV_TYPE: prov.model.PROV['SoftwareAgent'], 'ont:Extension': 'py'})
        resource = doc.entity('bdp:wc8w-nujj', {'prov:label': 'Boston Government Employee Earnings',
