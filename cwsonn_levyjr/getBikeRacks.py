...
class getBikeRacks(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        #Agent
        this_script = doc.agent('alg:getBikeRacks', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        #Resource
        resource = doc.entity('bod:2868d370c55d4d458d4ae2224ef8cddd_7', {'prov:label':'BikeRacks', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'geojson'})
        ...
        #New dataset
        open_space = doc.entity('dat:bikerack', {prov.model.PROV_LABEL:'BikeRacks', prov.model.PROV_TYPE:'ont:DataSet'})
...
'''getBikeRacks.execute()
doc = getBikeRacks.provenance()
print(doc.get_provn())
