...
class avgDistance(dml.Algorithm):
	...
	reads = ['debhe_shizhan0_wangdayu_xt.busHubwayDistance', 'debhe_shizhan0_wangdayu_xt.subwayHubwayDistance', 'debhe_shizhan0_wangdayu_xt.schoolHubwayDistance']
	writes = ['debhe_shizhan0_wangdayu_xt.avgDistance']
	...
	def execute(trial = False):
		...
		repo['debhe_shizhan0_wangdayu_xt.avgDistance'].insert_many(avgDistance)
		repo['debhe_shizhan0_wangdayu_xt.avgDistance'].metadata({'complete': True})
		print("Saved avgDistance", repo['debhe_shizhan0_wangdayu_xt.avgDistance'].metadata())
	...
	def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
		...
		this_script = doc.agent('alg:debhe_shizhan0_wangdayu_xt#avgDistance',
		...
		avgDistance = doc.entity('dat:debhe_shizhan0_wangdayu_xt#avgDistance',
