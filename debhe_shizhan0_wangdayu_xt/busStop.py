...
class busStop(dml.Algorithm):
    ...
    reads = []
    writes = ["debhe_shizhan0_wangdayu_xt.busStop"]
    ...
    def execute(trial = False):
        ...
        repo['debhe_shizhan0_wangdayu_xt.busStop'].insert_many(r)
        repo['debhe_shizhan0_wangdayu_xt.busStop'].metadata({'complete':True})
        print(repo['debhe_shizhan0_wangdayu_xt.busStop'].metadata())
        ...
        repo.dropCollection("debhe_shizhan0_wangdayu_xt.busStop")
        repo.createCollection("debhe_shizhan0_wangdayu_xt.busStop")

        repo['debhe_shizhan0_wangdayu_xt.busStop'].insert_many(busStop2)
        repo['debhe_shizhan0_wangdayu_xt.busStop'].metadata({'complete':True})
        print(repo['debhe_shizhan0_wangdayu_xt.busStop'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:debhe_shizhan0_wangdayu_xt#busStop', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        busStop = doc.entity('dat:debhe_shizhan0_wangdayu_xt#busStop', {prov.model.PROV_LABEL:'Bus Stop Location', prov.model.PROV_TYPE:'ont:DataSet'})
