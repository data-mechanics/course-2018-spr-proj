...
class allSchool(dml.Algorithm):
    ...
    reads = ['debhe_wangdayu.publicSchool', 'debhe_wangdayu.privateSchool']
    writes = ['debhe_wangdayu.allSchool']
    ...
    def execute(trial = False):
        ...
        #repo.authenticate('debhe_wangdayu', 'debhe_wangdayu')
        repo.dropCollection('debhe_wangdayu.allSchool')
        repo.createCollection('debhe_wangdayu.allSchool')
        repo['debhe_wangdayu.allSchool'].insert_many(allSchool)
        repo['debhe_wangdayu.allSchool'].metadata({'complete':True})
    ...
    # Set up the database connection.
        ...
        this_script = doc.agent('alg:debhe_wangdayu#allSchool', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        allSchool = doc.entity('dat:debhe_wangdayu#allSchool', {prov.model.PROV_LABEL:'All School location', prov.model.PROV_TYPE:'ont:DataSet'})
