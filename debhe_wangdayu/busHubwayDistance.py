...
class busHubwayDistance(dml.Algorithm):
    ...
    reads = ['debhe_wangdayu.busStop', 'debhe_wangdayu.hubwayStation']
    writes = ['debhe_wangdayu.busHubwayDistance']
    ...
    def execute(trial = False):
        ...
        busStops = []
        busStops = repo['debhe_wangdayu.busStop'].find()
        ...
        repo['debhe_wangdayu.busHubwayDistance'].insert_many(minDistance)
        repo['debhe_wangdayu.busHubwayDistance'].metadata({'complete': True})
        print("Saved busHubwayDistance", repo['debhe_wangdayu.busHubwayDistance'].metadata())
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:debhe_wangdayu#busHubwayDistance',
        ...
        busHubwayDistance = doc.entity('dat:debhe_wangdayu#busHubwayDistance',
