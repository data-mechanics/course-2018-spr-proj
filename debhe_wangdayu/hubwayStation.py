...
class hubwayStation(dml.Algorithm):
    ...
    reads = []
    writes = ['debhe_wangdayu.hubwayStation']
    ...
    def execute(trial = False):
        ...
        repo.dropCollection("debhe_wangdayu.hubwayStation")
        repo.createCollection("debhe_wangdayu.hubwayStation")
        repo['debhe_wangdayu.hubwayStation'].insert_many(ps)
        repo['debhe_wangdayu.hubwayStation'].metadata({'complete':True})
        print(repo['debhe_wangdayu.hubwayStation'].metadata())
        repo.logout()
    ...
    # Set up the database connection.
        ...
        this_script = doc.agent('alg:debhe_wangdayu#hubwayStation', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        hubwayStation = doc.entity('dat:debhe_wangdayu#hubwayStation', {prov.model.PROV_LABEL:'Hubway station location', prov.model.PROV_TYPE:'ont:DataSet'})
