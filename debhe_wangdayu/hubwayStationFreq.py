...
class hubwayStationFreq(dml.Algorithm):
	...
	writes = ['debhe_wangdayu.hubwayStationFreq']
	...
	def execute(trial = False):
		...
		repo['debhe_wangdayu.hubwayStationFreq'].insert_many(result)
		repo['debhe_wangdayu.hubwayStationFreq'].metadata({'complete': True})
		print("Saved hubwayStationFreq", repo['debhe_wangdayu.hubwayStationFreq'].metadata())
	...
	def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
		...
		this_script = doc.agent('alg:debhe_wangdayu#hubwayStationFreq',
		...
		hubwayStationFreq = doc.entity('dat:debhe_wangdayu#hubwayStationFreq',
