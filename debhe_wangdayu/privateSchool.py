...
class privateSchool(dml.Algorithm):
    ...
    reads = []
    writes = ['debhe_wangdayu.privateSchool']
    ...
    def execute(trial = False):
        ...
        repo['debhe_wangdayu.privateSchool'].insert_many(ps)
        repo['debhe_wangdayu.privateSchool'].metadata({'complete':True})
        print(repo['debhe_wangdayu.privateSchool'].metadata())
    ...
    # Set up the database connection.
        ...
        this_script = doc.agent('alg:debhe_wangdayu#privateSchool', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        privateSchool = doc.entity('dat:debhe_wangdayu#privateSchool', {prov.model.PROV_LABEL:'private School', prov.model.PROV_TYPE:'ont:DataSet'})
