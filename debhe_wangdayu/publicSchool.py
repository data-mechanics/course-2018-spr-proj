...
class publicSchool(dml.Algorithm):
    ...
    reads = []
    writes = ['debhe_wangdayu.publicSchool']
    ...
    def execute(trial = False):
        ...
        repo['debhe_wangdayu.publicSchool'].insert_many(ps)
        repo['debhe_wangdayu.publicSchool'].metadata({'complete':True})
        print(repo['debhe_wangdayu.publicSchool'].metadata())
    ...
    # Set up the database connection.
        ...
        this_script = doc.agent('alg:debhe_wangdayu#publicSchool', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        publicSchool = doc.entity('dat:debhe_wangdayu#publicSchool', {prov.model.PROV_LABEL:'pulic School', prov.model.PROV_TYPE:'ont:DataSet'})
