...
class restaurantHubwayDistance(dml.Algorithm):
    ...
    reads = ['debhe_wangdayu.restaurants', 'debhe_wangdayu.hubwayStation']
    writes = ['debhe_wangdayu.restautantHubwayDistance']
    ...
    def execute(trial = False):
        ...
        restaurant_3 = repo['debhe_wangdayu.restaurants'].find()
        ...
        repo['debhe_wangdayu.restaurantHubwayDistance'].insert_many(minDistance)
        repo['debhe_wangdayu.restaurantHubwayDistance'].metadata({'complete': True})
        print("Saved restaurantHubwayDistance", repo['debhe_wangdayu.restaurantHubwayDistance'].metadata())
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        restaurantHubwayDistance = doc.entity('dat:debhe_wangdayu#restaurantHubwayDistance',
