...
class subwayHubwayDistance(dml.Algorithm):
    ...
    reads = ['debhe_wangdayu.subwayStop', 'debhe_wangdayu.hubwayStation']
    writes = ['debhe_wangdayu.subwayHubwayDistance']
    ...
    def execute(trial = False):
        ...
        repo['debhe_wangdayu.subwayHubwayDistance'].insert_many(minDistance)
        repo['debhe_wangdayu.subwayHubwayDistance'].metadata({'complete': True})
        print("Saved subwayHubwayDistance", repo['debhe_wangdayu.subwayHubwayDistance'].metadata())
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        subwayHubwayDistance = doc.entity('dat:debhe_wangdayu#subwayHubwayDistance',
