...
class subwayStop(dml.Algorithm):
    ...
    reads = []
    writes = ['debhe_wangdayu.subwayStop']
    ...
    def execute(trial = False):
        ...
        repo['debhe_wangdayu.subwayStop'].insert_many(subStop)
        repo['debhe_wangdayu.subwayStop'].metadata({'complete':True})
        print(repo['debhe_wangdayu.subwayStop'].metadata())
    ...
    # Set up the database connection.
        ...
        this_script = doc.agent('alg:debhe_wangdayu#subwayStop', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        subwayStop = doc.entity('dat:debhe_wangdayu#subwayStop', {prov.model.PROV_LABEL:'MBTA subway stop', prov.model.PROV_TYPE:'ont:DataSet'})
