...
class demographics_versus_mbta(dml.Algorithm):
    contributor = 'fjansen'
    reads = ['fjansen.commuting', 'fjansen.povertyrates', 'fjansen.race']
    writes = ['fjansen.demographics_versus_commuting']
    ...
    def execute(trial=False):
        ...
        pov_db = repo['fjansen.povertyrates']
        ...
        repo['fjansen.demographics_versus_mbta'].insert_one(merged_data)
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        doc.add_namespace('race', 'dat:fjansen#race')
        doc.add_namespace('povertyrates', 'dat:fjansen#povertyrates')
        doc.add_namespace('commuting', 'dat:fjansen#commuting')

        ## Agents
        this_script = doc.agent('alg:fjansen#demographics_versus_mbta',
        ...
        ## Entitites
        resource1 = doc.entity('race: dat:fjansen#race',
                               {'prov:label': 'Race by Neighborhood', prov.model.PROV_TYPE: 'ont:DataResource',
                                'ont:Extension': 'json'})
        resource2 = doc.entity('commuting: dat:fjansen#commuting',
                               {'prov:label': 'Means of Commuting by Neighborhood',
                                prov.model.PROV_TYPE: 'ont:DataResource', 'ont:Extension': 'json'})
        resource3 = doc.entity('dat:fjansen#povertyrates',
