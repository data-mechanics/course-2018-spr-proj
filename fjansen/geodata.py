...
class geodata(dml.Algorithm):
    ...
    def execute(trial=False):
        ...
        repo['fjansen.geodata'].insert_one(data)
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        ## Agents
        this_script = doc.agent('alg:fjansen#geodata',
        ...
        ## Entities
        # Data Source
        resource = doc.entity('geodata:GetUSDemographics',
                              {'prov:label': 'Lifestyle Data By Neighborhood', prov.model.PROV_TYPE: 'ont:DataResource',
                               'ont:Extension': 'json'})
        # Data Generated
