...
class parking(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        resource = doc.entity('bos: 53ebc23fcc654111b642f70e61c63852_0', {'prov:label': 'Snow Emergency Parking', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        ...
        parking = doc.entity('dat:lliu_saragl#parking',{prov.model.PROV_LABEL:'Snow Emergency Parking', prov.model.PROV_TYPE:'ont:DataSet'})
        doc.wasAttributedTo(parking, this_script)
        doc.wasGeneratedBy(parking, get_parking, endTime)
        doc.wasDerivedFrom(parking, get_parking, get_parking, get_parking)
