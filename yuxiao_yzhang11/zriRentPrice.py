...
def csvConvert():
    url = "http://datamechanics.io/data/boston_Zip_Zri_AllHomesPlusMultifamily_Summary.csv"
...
class zriRentPrice(dml.Algorithm):
    contributor = 'yuxiao_yzhang11'
    reads = []
    writes = ['yuxiao_yzhang11.zri']
    ...
    def execute(trial=False):
        ...
        repo.dropCollection("zri")
        repo.createCollection("zri")
        repo['yuxiao_yzhang11.zri'].insert_many(dict_values)
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:yuxiao_yzhang11#zri',
                                {prov.model.PROV_TYPE: prov.model.PROV['SoftwareAgent'], 'ont:Extension': 'py'})

        resource = doc.entity('dat:boston_Zip_Zri_AllHomesPlusMultifamily_Summary',
        ...
        output =  doc.entity('dat:yuxiao_yzhang11.zri', {prov.model.PROV_LABEL:'zri', prov.model.PROV_TYPE:'ont:DataSet'})
...
zriRentPrice.execute()
doc = zriRentPrice.provenance()
print(doc.get_provn())
